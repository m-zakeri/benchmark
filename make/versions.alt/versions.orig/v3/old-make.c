...
#define INCLUDEDIR "/usr/local/include" /* modification by J.Ruthruff,
8/25 */
	...
	while (d != 0)
	  {
	    ...
	    if (f == NULL || !f->double_colon)
	      {
#ifndef F_JR_2  /* seeded fault #2; J.Ruthruff */
...
/* #include "make.h"  <- modification by J.Ruthruff, 7/27 */
/* #include "dep.h"  <- modification by J.Ruthruff, 7/27 */
/* #include "filedef.h"  <- modification by J.Ruthruff, 7/27 */
/* #include "variable.h"  <- modification by J.Ruthruff, 7/27 */
#include "job.h"
/* #include "commands.h"  <- modification by J.Ruthruff, 7/27 */
#undef stderr
#define stderr stdout
     ...
     struct file *file;
{
 ...
 #ifndef F_JR_6  /* seeded fault #6; J.Ruthruff */
...
#ifndef F_JR_7  /* seeded fault #7; J.Ruthruff */
  if (job_rfd >= 0)
#else
  if (job_rfd > 0)
#endif
...
#ifndef F_JR_10  /* seeded fault #10; J.Ruthruff */
...
/* #include "commands.h"  <- modification by J.Ruthruff, 7/27 */
/* #include "variable.h"  <- modification by J.Ruthruff, 7/27 */
/* #include "rule.h"  <- modification by J.Ruthruff, 7/27 */
#undef stderr
#define stderr stdout
...
#else
    o = variable_buffer_output (o, "command line", 9);
#endif
	break;
      case o_override:
